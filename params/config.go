...
var (
	...
	// and accepted by the Calcium core developers into the Ethash consensus.
	...
	// and accepted by the Calcium core developers into the Clique consensus.
	...
	// and accepted by the Calcium core developers for testing proposes.
