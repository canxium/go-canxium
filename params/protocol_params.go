...
var (
	...
	GenesisDifficulty      = big.NewInt(100_000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(100_000) // The minimum that the difficulty may ever be.
	DurationLimit          = big.NewInt(13)      // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.

	// Canxium params
	CanxiumInitialBaseFeeDifficulty = big.NewInt(1e16)   // 10P ~ Difficulty where base fee = initbasefee in canxium chain
