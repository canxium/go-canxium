...
// ecrecover extracts the Calcium account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Calcium address
...
// Calcium testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Calcium address of the signing key
...
// Author implements consensus.Engine, returning the Calcium address recovered
