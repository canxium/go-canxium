...
// mapped from textual names used in the tests below to actual Calcium private
...
// address retrieves the Calcium address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Calcium address
