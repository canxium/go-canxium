...
// all blocks' seal as valid, though they still have to conform to the Calcium
// consensus rules.
...
// still have to conform to the Calcium consensus rules.
...
// they still have to conform to the Calcium consensus rules.
