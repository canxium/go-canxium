...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Calcium address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Calcium account at a particular block.
    type Account {
    ...
    # Transaction is an Calcium transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Calcium account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Calcium account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Calcium block by number or by hash. If neither is
