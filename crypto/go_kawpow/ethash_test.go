...
func TestHashimotoLight(t *testing.T) {
	...
	t.Run("BasicFunctionality", func(t *testing.T) {
		...
		headerHash := common.HexToHash("0xf1b8bb24298991c9c93217ea401c539269d1c35c52de6cc7d8f14e4266605407")
		nonce := uint64(0x531A1379C825CE7F)

		// Expected results for real ethash (not test mode)
		expectedMixHash := common.HexToHash("0x8b6e4198d77cfc82a87dcfd5417e139ab940ff78b7d7463108a5c205ca8a6c12")
		expectedPowHash := common.HexToHash("0x0000137522bae98c0ced779afb8fec0ce3d59f58ee0d5ef11bcb6f9b1b46d5be")

		t.Logf("=== ETHASH HASHIMOTO LIGHT TEST ===")
		...
		// Call HashimotoLight
		mixHash, finalHash := ethash.HashimotoLight(blockNumber, headerHash, nonce)
...
func TestProgPoW(t *testing.T) {
	...
	t.Run("BasicFunctionality", func(t *testing.T) {
		...
		// Expected results for real ethash (not test mode)
		expectedMixHash := common.HexToHash("0x6018c151b0f9895ebe44a4ca6ce2829e5ba6ae1a68a4ccd05a67ac01219655c1")
		expectedPowHash := common.HexToHash("0x34d8436444aa5c61761ce0bcce0f11401df2eace77f5c14ba7039b86b5800c08")
		...
		// Call HashimotoLight
		mixHash, finalHash := ethash.ProgpowHash(blockNumber, headerHash, nonce)
