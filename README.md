...
Transitioning towards developers, if you'd like to play around with creating Calcium
 ...
 * Instead of connecting to the main Calcium network, the client will connect to the Görli
...
Go Calcium also supports connecting to the older proof-of-authority based test network
...
One of the quickest ways to get Calcium up and running on your machine is by using
Docker:
