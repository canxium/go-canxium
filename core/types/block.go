...
// Package types contains data types related to Calcium consensus.
package types
...
// Header represents a block header in the Calcium blockchain.
type Header struct {
...
// Block represents an entire block in the Calcium blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Calcium RLP block format.
